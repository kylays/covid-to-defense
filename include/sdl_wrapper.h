 ...
 * @param object object to be changed upon keypress
 */
 ...
 * @param object object to be changed upon keypress
 */
typedef void (*mouse_handler_t)(mouse_event_type_t type, vector_t mouse_pos, void *object);
 ...
 *
 * @param object the object to be updated based on keypresses
...
/**
 * Registers a function to be called every time mouse is pressed.
 * Overwrites any existing handler.
 *
 * @param handler the function to call with each key press
 */
...
/**
 * @brief pauses the SLD window for number_of_seconds
 * 
...
/**
 * @brief Get the window center object.
 *
 * @return vector_t
 */
...
/**
 * @brief Create a font object. If invalid .ttf path,
 * font rendered is Vertigo which is the default font.
 * 
 * @param font_path font .ttf filename
 * @param font_size 
 * @return TTF_Font* 
 */
TTF_Font *create_font(const char *font_path, int font_size);
//REMEMBER TO USE CREATE FONT AFTER INITIALIZING THE SCENE
