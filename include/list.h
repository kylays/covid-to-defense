...
/**
 * Gets the capacity of a list (the maximum number of elements).
 * Note that this is NOT the list's size.
 *
 * @param list a pointer to a list returned from list_init()
 * @return the max number of elements that can be in the list
 */
